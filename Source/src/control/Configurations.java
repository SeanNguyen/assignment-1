...
public class Configurations {
	public static final String APP_TITTLE = "Key Word in Context TEAM 4";
	...
	public static final String DIR_ROOTLAYOUT_FXML = "../view/RootLayout.fxml";
	public static final String DIR_KWIC_FXML = "../view/Kwic.fxml";
}
